...
class Publications:
    def __init__(self, client: Client, subsctiptions: set[int]= None, history_limit: int = 5):
        ...
        self.message_handler = MessageHandler(self.__new_message_handler, filters.chat(self.subsctiptions))
    ...
    async def update_subsctiptions(self, new_subsctiptions: set[int]):
        ...
        self.message_handler = MessageHandler(self.__new_message_handler, filters.chat(list(self.subsctiptions)))
